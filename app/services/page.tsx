...
const PROCESS_STEPS = [
  { 
    title: '先聽懂你的商業目標', 
    eng: 'Discovery', 
    desc: '我不急著談技術，而是先理解你的痛點。透過有邏輯的引導，幫你把模糊的想法，收斂成具體可執行的需求清單。' 
  },
  { 
    title: '轉化為邏輯清晰的藍圖', 
    eng: 'Planning', 
    desc: '這是最關鍵的一步。我將你的需求整理為開發規格與架構圖，確保我們對成品的想像完全一致，避免無謂的開發浪費。' 
  },
  { 
    title: '透明且有節奏的開發', 
    eng: 'Development', 
    desc: '告別黑箱作業。我採用小步驟迭代的方式開發，讓你隨時掌握進度。每一個階段都是穩扎穩打，降低專案風險。' 
  },
  { 
    title: '交付好用的工具', 
    eng: 'Delivery', 
    desc: '不只交付程式碼，更包含完整的測試與操作說明。讓你無痛接手，確保系統上線就能立即發揮價值。' 
  }
];
